...
if __name__ == '__main__':
    assert len(sys.argv) >= 2, 'Please supply a config file to AutoProf. See the examples in the \'test\' folder that came with AutoProf'
